...
import 'features/detect/detect_page.dart';
  ...
  routes: [
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(path: '/detect', builder: (context, state) => const DetectPage()),
        GoRoute(
...
GoRoute(
  ...
  builder: (context, state) {
    ...
    final confidence = double.tryParse(state.uri.queryParameters['conf'] ?? '') ?? 0.0;
